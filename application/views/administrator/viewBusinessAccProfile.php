    ...
    <div class="animated fadeIn">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <?php
                foreach ($businessDataById as $profiledt)
                {
                    ?>
                    <div class="card">
                        ...
                        <section class="card">
                            <div class="card-header user-header alt bg-dark">
                                <div class="media">
                                    <a href="#">
                                        <img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;" alt="" src="<?php echo base_url(); ?>public/administratorDesign/images/g-logo.jpg">
                                    </a>
                                    <div class="media-body">
                                        <h2 class="text-light display-6"><?php echo $profiledt->business_title; ?></h2>
                                        <p><?php
                                            if ($profiledt->type == 'a')
                                            {
                                                echo 'Admin';
