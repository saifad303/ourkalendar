                ...
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        ...
                        foreach ($eventDetail as $detail)
                        {
                            ...
                            <form action="<?php echo base_url() . "Event_Management/updateEventByAdminFromAllEvent"; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="time" value="<?php echo $detail->endTime; ?>" id="text-input" name="endTime" placeholder="Text" class="form-control"></div>
                                </div>
