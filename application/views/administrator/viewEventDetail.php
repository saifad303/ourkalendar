                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <br>
                                    ...
                                    <a href="<?php echo base_url() . "Event_Management/adminEventEdit/" . $detail->id; ?>"><button type="button" class="btn btn-info">Edit Event Info</button></a>
                                    <a href="<?php echo base_url() . "Event_Management/eventActivation/" . $detail->id; ?>"><button type="button" class="btn btn-success">Active</button></a>

                                    <a href="<?php echo base_url() . "Event_Management/eventDelete/" . $detail->id; ?>"><button type="button" class="btn btn-danger">Delete post</button></a>
