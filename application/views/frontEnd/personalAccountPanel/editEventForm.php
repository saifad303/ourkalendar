                        ...
                        <div class="wizard-container">
                            <div class="card wizard-card" data-color="orange" id="wizardProfile">
                                ...
                                foreach ($eventDetail as $detail)
                                {
                                    ...
                                    <form action="<?php echo base_url() . "Event_Management/newUpdateEvent"; ?>" enctype="multipart/form-data" method="post">
                                        ...
                                        if ($validationcheck == "")
                                        {
                                            ...
                                            <div class="wizard-header text-center">
                                                <h3 class="wizard-title">Edit your event</h3>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane" id="td">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-10 col-sm-offset-1">
                                                        <div class="form-group">
                                                            ...
                                                            <input value="<?php echo $detail->title; ?>" name="title" type="text" class="form-control" id="title-input" placeholder="Event Title" <?php echo $validationcheck; ?>>
                                                            <?php echo form_error('title', "<div class='alert alert-danger'>", "</div>"); ?>
                                                            <input type="hidden" value="<?php echo $detail->id; ?>" name="eventid">
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-10 col-sm-offset-1">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea <?php echo $validationcheck; ?> class="form-control" id="description-input" name="descr" placeholder="Description" rows="9"><?php echo $detail->description; ?></textarea>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-10 col-sm-offset-1">
                                                        <select <?php echo $validationcheck; ?> name="purchase" id="pt" class="form-control">
                                                            ...
                                                            if ($detail->price > 0)
                                                            {
                                                                ...
                                                                <input type="hidden" id="evPrice" value="<?php echo $detail->price ?>">
                                                                <?php
                                                            }
                                                            else
                                                            {
                                                                ...
                                                                <input type="hidden" id="evPrice" value="<?php echo 0 ?>">
                                                                <?php
                                                            }
                                                            ?>
                                                        </select>
                                                    ...
                                                    <div class="col-sm-10 col-sm-offset-1">
                                                        ...
                                                        <div class="">
                                                            <div class="form-group">
                                                                ...
                                                                <input <?php echo $validationcheck; ?> id="date" value="<?php echo $detail->startTime; ?>" id="start-time" class="form-control" name="startTime" type="time">
                                                        ...
                                                        <div class="">
                                                            <div class="form-group">
                                                                ...
                                                                <input value="<?php echo $detail->endTime; ?>" <?php echo $validationcheck; ?> id="date" id="end-time" class="form-control" name="endTime" type="time">
                                                        ...
                                                        <div class="">
                                                            <div class="form-group">
                                                                ...
                                                                <input value="<?php echo $detail->startDate; ?>" <?php echo $validationcheck; ?> id="date" id="start-date" class="form-control" name="startDate" type="date">
                                                        ...
                                                        <div class="">
                                                            <div class="form-group">
                                                                ...
                                                                <input value="<?php echo $detail->endDate; ?>" id="date" id="end-date" class="form-control"  name="endDate" type="date">
                                            ...
                                            <div class="tab-pane" id="type">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-10 col-sm-offset-1">
                                                        ...
                                                        <div class="form-group">
                                                            <select <?php echo $validationcheck; ?> name="category" id="set-category" class="form-control">
                                                                ...
                                                                foreach ($categoryList as $catlist)
                                                                {
                                                                    ...
                                                                    {
                                                                        ?>
                                                                        <option selected value="<?php echo $catlist->id; ?>"><?php echo $catlist->category_name; ?></option>
                                                                        <?php
                                                                    }
                                                                }
                                                                ?>
                                                        ...
                                                        <div class="form-group">
                                                            <select <?php echo $validationcheck; ?> name="venue" id="set-venue" class="form-control">
                                                                ...
                                                                {
                                                                    if ($detail->venueid == $vdt->id)
                                                                    {
                                                                        ?>
                                                                        <option selected value="<?php echo $vdt->id; ?>"><?php echo $vdt->venue_type; ?></option>
                                                                        <?php
                                                                    }
                                                                }
                                                                ?>
                                                        ...
                                                        <div class="form-group">
                                                            <select <?php echo $validationcheck; ?> name="purpose" id="set-purpose" class="form-control">
                                                                ...
                                                                {
                                                                    if ($detail->eventpurposeid == $pdt->id)
                                                                    {
                                                                        ?>
                                                                        <option selected value="<?php echo $pdt->id; ?>"><?php echo $pdt->purpose_type; ?></option>
                                                                        <?php
                                                                    }
                                                                }
                                                                ?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-7 col-sm-offset-1">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select <?php echo $validationcheck; ?> class="form-control" id="set-country" name="country">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select <?php echo $validationcheck; ?> class="form-control" id="set-city" name="city">
                                                                ...
                                                                foreach ($cityList as $list)
                                                                {
                                                                    ...
                                                                    {
                                                                        ?>
                                                                        <option selected value="<?php echo $list->id; ?>"><?php echo $list->city_name; ?></option>
                                                                        <?php
                                                                    }
                                                                }
                                                                ?>
                                                    ...
                                                    <div class="col-sm-5 col-sm-offset-1">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea <?php echo $validationcheck; ?> class=" form-control" id="address-l1" name="adrssL1" rows="3" placeholder="Specify event location"><?php echo $detail->eventLocationL1; ?></textarea>
                                                    ...
                                                    <div class="col-sm-5">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea <?php echo $validationcheck; ?> class="form-control" id="address-l2" name="adrssL2" rows="3" placeholder="Specify event location"><?php echo $detail->eventLocationL2; ?></textarea>
                                                            <?php echo form_error('adrssL2', "<div class='alert alert-danger'>", "</div>"); ?>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="col-sm-4 col-sm-offset-1">
                                                                <div class="picture-container">
                                                                    <div class="picture">
                                                                        ...
                                                                        <input <?php echo $validationcheck; ?> type="file" value="" name="pic" id="wizard-picture">
...
//                    alert("paid");
                    ...
                    t += '          <label>Price</label>';
                    t += '          <input name="price" value="' + evPrice + '" type="text" class="form-control" placeholder="$">';
                    t += '        </div>';
                    t += '       </div>';
                    t += '    </div>';
