                                ...
                                <div style="border: 1px solid #ccc;box-shadow: 0 1px 6px #ccc;background-color: white">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            {
                                                ?>
                                                <h4 style="padding: 5px 20px;border-bottom: 1px solid #e2e2e2;margin: 0">Name:<span> <input type="text" name="uname" value="<?php echo $info->business_title; ?>" class="form-control"></span></h4>
